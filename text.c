...
static void setColor(int color, DWORD *ptr)
{
	*ptr++ = colors[color];
}
...
{
	DWORD *ptr = pixels + (HEIGHT - y) * WIDTH + x;
...
void vprintRaw(DWORD *ptr, char ascii)
{
	char *pchar = asciiset + 8 * ascii;
	for(int i = 0; i < 8; i++)
	{
